...
const SIMILAR_POSTS = [
  { id: 2, title: "고양이 방문 돌봄 구합니다", district: "마포구", price: "25,000원/시간", createdAt: "1일 전", status: "모집중" },
  { id: 3, title: "주말 강아지 위탁 돌봄", district: "용산구", price: "50,000원/일", createdAt: "3일 전", status: "모집중" },
  { id: 4, title: "소형견 산책 파트타임", district: "서대문구", price: "18,000원/시간", createdAt: "5일 전", status: "확정" },
];
        ...
        <div className="max-w-[1280px] mx-auto px-10 py-8">
          <div className="flex gap-8 items-start">
            ...
            <div className="flex-1 min-w-0 flex flex-col gap-6">
              ...
              {/* 목록으로 */}
              <Link href="/board" className="flex items-center gap-2 text-gray-500 hover:text-orange-500 transition-colors w-fit">
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-2">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-stone-900 text-base font-medium">{POST.location}</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-stone-900 text-base font-medium">{POST.period}</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-stone-900 text-base font-medium">{POST.time}</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-orange-500 text-base font-medium">{POST.price}</p>
                        <p className="text-gray-500 text-xs">{POST.priceNote}</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex gap-3">
                ...
                <button className="flex-1 h-11 flex items-center justify-center gap-2 bg-orange-500 rounded-[10px] text-white text-base font-medium hover:bg-orange-600 transition-colors">
              ...
              <div className="bg-white rounded-2xl shadow-[0px_2px_12px_0px_rgba(232,116,42,0.10)] border border-orange-100 p-5 flex flex-col gap-4">
                ...
                <p className="text-stone-900 text-base leading-7 whitespace-pre-line">{POST.description}</p>
              </div>
              ...
              {/* 댓글 */}
              <div className="bg-white rounded-2xl shadow-[0px_2px_12px_0px_rgba(232,116,42,0.10)] border border-orange-100 p-5 flex flex-col gap-4">
                <h2 className="text-stone-900 text-xl font-bold">댓글 {COMMENTS.length}</h2>
                ...
                <div className="flex items-start gap-3 pb-6 border-b border-orange-100">
                  <div className="w-10 h-10 bg-orange-50 rounded-full border-2 border-orange-100 flex items-center justify-center shrink-0">
                    <span className="text-orange-500 text-base font-semibold">나</span>
                  </div>
                ...
                <div className="flex flex-col gap-6 pt-2">
                  {COMMENTS.map((c) => (
                    <div key={c.id} className="flex items-start gap-3">
                      <div className="w-10 h-10 bg-orange-50 rounded-full border-2 border-orange-100 flex items-center justify-center shrink-0">
                        <span className="text-orange-500 text-base font-semibold">{c.initial}</span>
                      </div>
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          <span className="text-stone-900 text-sm font-semibold">{c.author}</span>
                          <span className="text-gray-500 text-xs">{c.createdAt}</span>
                        </div>
                        <p className="text-stone-900 text-sm leading-5 mb-2">{c.content}</p>
            ...
            <div className="w-96 shrink-0 flex flex-col gap-6 sticky top-20">
              ...
              {/* 작성자 정보 */}
              <div className="bg-white rounded-2xl shadow-[0px_2px_12px_0px_rgba(232,116,42,0.10)] border border-orange-100 p-5 flex flex-col gap-4">
                <h3 className="text-stone-900 text-lg font-bold">작성자 정보</h3>
                <div className="flex items-start gap-3">
                  <div className="w-14 h-14 bg-orange-50 rounded-full border-2 border-orange-100 flex items-center justify-center shrink-0">
                    <span className="text-orange-500 text-xl font-semibold">{POST.author.initial}</span>
                  </div>
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      <span className="text-stone-900 text-base font-semibold">{POST.author.name}</span>
                      {POST.author.verified && (
                        <span className="px-2 py-0.5 bg-orange-500 rounded text-white text-[9px] font-medium">인증</span>
                      )}
                    </div>
                    <div className="flex items-center gap-1 mb-1">
                      <MapPin className="w-3.5 h-3.5 text-gray-400" />
                      <span className="text-gray-500 text-sm">{POST.author.district}</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="flex items-center gap-1">
                        <Star className="w-3.5 h-3.5 fill-amber-400 text-amber-400" />
                        <span className="text-stone-900 text-sm font-bold">{POST.author.rating}</span>
                        <span className="text-gray-500 text-xs">({POST.author.reviews})</span>
                      </div>
                      <span className="text-gray-500 text-xs">가입 {POST.author.joinDate}</span>
                    </div>
                  </div>
                </div>
                <Link
              ...
              <div className="bg-white rounded-2xl shadow-[0px_2px_12px_0px_rgba(232,116,42,0.10)] border border-orange-100 p-5 flex flex-col gap-4">
                <div className="flex items-center justify-between">
                  <h3 className="text-stone-900 text-lg font-bold">비슷한 구인글</h3>
                  <Link href="/board" className="text-orange-500 text-xs font-medium hover:underline">더보기</Link>
                </div>
                    ...
                    <Link key={p.id} href={`/board/${p.id}`}>
                      <div className="p-3 bg-orange-50 rounded-lg hover:bg-orange-100 transition-colors cursor-pointer">
                        <div className="flex items-start justify-between mb-1">
                          <p className="text-stone-900 text-sm font-medium flex-1 truncate pr-2">{p.title}</p>
                          <span className={`shrink-0 px-2 py-0.5 rounded text-[9px] font-medium ${
                            p.status === "모집중" ? "bg-emerald-50 text-emerald-500" : "bg-orange-50 text-orange-500"
                          }`}>
                            {p.status}
                          </span>
                        </div>
                        <div className="flex items-center gap-1 mb-1">
                          ...
                          <span className="text-gray-500 text-xs">{p.district}</span>
                        </div>
                        <div className="flex items-center justify-between">
                          <span className="text-orange-500 text-xs font-semibold">{p.price}</span>
                          <span className="text-gray-500 text-xs">{p.createdAt}</span>
                        </div>
                      </div>
                    </Link>
                  ))}
              ...
              <div className="bg-white rounded-2xl shadow-[0px_2px_12px_0px_rgba(232,116,42,0.10)] border border-orange-100 p-5 flex flex-col gap-3">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-stone-900 text-lg font-bold">안전 거래 팁</h3>
                </div>
                <ul className="flex flex-col gap-2">
                  {SAFETY_TIPS.map((tip) => (
                    <li key={tip} className="flex items-start gap-2">
                      <span className="text-gray-500 text-xs mt-0.5">•</span>
                      <span className="text-gray-500 text-xs leading-4">{tip}</span>
                    </li>
                  ))}
                </ul>
              </div>
