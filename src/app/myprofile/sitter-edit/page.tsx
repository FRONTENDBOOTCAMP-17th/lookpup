  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <input
        ...
        className={`w-full h-12 ${icon ? "pl-9" : "pl-4"} pr-4 bg-white border border-orange-100 rounded-[10px] text-[15px] text-stone-900 placeholder:text-gray-400 outline-none focus:border-orange-300 transition-colors`}
      />
    </div>
  );
}
          ...
          <div className="flex flex-col lg:flex-row gap-4 lg:gap-8 items-start">
            ...
            <div className="w-full lg:w-80 lg:shrink-0 space-y-4">
              ...
              <div>
                ...
                <Card>
                  {/* 이미지 프리뷰 */}
                  <div className="relative w-full h-64 bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl overflow-hidden flex items-center justify-center mb-5">
                    <Avatar
            ...
            <div className="w-full lg:flex-1 lg:min-w-0 space-y-4">
              ...
              <div>
                ...
                <Card>
                  ...
                  <div className="h-48 lg:h-64 bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl flex flex-col items-center justify-center gap-2 mb-4">
