...
function PetsitterCard({
  name, initial, district, rating, reviews, price, services, certified,
}: (typeof PETSITTERS)[0]) {
  return (
    ...
    <>
      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-b from-orange-50 via-stone-50/20 to-white min-h-[600px] flex items-center overflow-hidden relative">
          {/* 배경 🐾 */}
          <span className="absolute left-20 top-20 text-6xl opacity-5 select-none pointer-events-none">🐾</span>
          <span className="absolute right-40 top-40 text-4xl opacity-5 select-none pointer-events-none">🐾</span>
          <span className="absolute left-[40%] bottom-20 text-5xl opacity-5 select-none pointer-events-none">🐾</span>
        ...
        <section className="py-16 md:py-20 bg-white">
          <div className="max-w-[1280px] mx-auto px-4 sm:px-10">
            <div className="text-center mb-12">
              <h2 className="text-2xl md:text-3xl font-semibold text-stone-900">어떤 돌봄이 필요하신가요?</h2>
          ...
          <div className="max-w-[1280px] mx-auto px-4 sm:px-10">
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center gap-3">
                <h2 className="text-2xl md:text-3xl font-semibold text-stone-900">내 주변 펫시터</h2>
                <span className="px-3 py-1 bg-orange-50 border border-orange-100 rounded-full text-orange-500 text-xs font-medium">
                  서울 마포구
                </span>
              </div>
              <Link href="/petsitters" className="flex items-center gap-1 text-orange-500 text-base font-medium hover:opacity-80 transition-opacity">
                더보기
        ...
        <section className="py-16 md:py-20 bg-white">
          <div className="max-w-[1280px] mx-auto px-4 sm:px-10">
            <h2 className="text-2xl md:text-3xl font-semibold text-stone-900 text-center mb-16">이용 방법</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 lg:gap-0 relative">
              ...
              {STEPS.map(({ num, title, desc }) => (
                <div key={num} className="flex lg:flex-col items-start lg:items-center gap-6 lg:gap-0 lg:text-center">
        ...
        <section className="py-16 md:py-20 bg-gradient-to-br from-orange-500 via-orange-500 to-stone-600">
          <div className="max-w-[1280px] mx-auto px-4 sm:px-10">
            <h2 className="text-2xl md:text-3xl font-semibold text-white text-center mb-12">안전한 거래를 보장합니다</h2>
