...
import { X, CheckCircle, CalendarDays, PawPrint } from "lucide-react";
      ...
      >
        ...
        <div className="px-6 py-4 flex gap-3 shrink-0">
          <button
            ...
            onClick={onClose}
            disabled={sending}
            className="flex-1 h-11 rounded-[10px] bg-white outline outline-1 outline-offset-[-1px] outline-orange-500 text-orange-500 text-sm font-medium transition-colors hover:bg-orange-50 disabled:opacity-50"
          >
            취소
          </button>
          <button
